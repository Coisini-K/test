<template>
  ...
  <table cellspacing="0" class="mockup_table">
    <tr class="mockup_tr">
      <td rowspan="7">
        <img :src="image || '@/assets/images/aos/1.webp'" class="mockup_img" />
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="td">
        ...
        <input type="text" class="itxt" v-model.number="quantities['1']" />
        <a href="javascript:;" class="increment" @click="increment('1')">+</a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="4">
        <div class="button_one">
          <button class="collection" @click="addToCollection">⭐收藏</button>
          <button class="purchase" @click="makePurchase">🕹️立即购买</button>
